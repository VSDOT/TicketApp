    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView>
        ...
        <View className="justify-center items-center my-2 mt-0">
          <TouchableOpacity
            ...
            <Text
              ...
              style={{fontSize: windowWidth > 500 ? 25 : 20 ,  fontFamily : 'Montserrat-SemiBold'}}
              onPress={() => {
        ...
        <View
          ...
          style={{flexDirection: 'row'}}>
          <Text className="text-black" style={{ fontFamily : 'Montserrat-SemiBold' , fontSize : 16 }}>Recent tickets</Text>
          <View
            className="items-center space-x-2"
            style={{flexDirection: 'row'}}>
            <Upload name="calendar-month-outline" size={23} color="black" />
            <Text className="text-black text-md" style={{ fontFamily : 'Montserrat-Medium' }}>
              Select the Date
            </Text>
          </View>
        </View>
        <FlatList
          ...
          ListEmptyComponent={
            <View
              ...
              <Text className='text-xl' style={{ fontFamily : 'Montserrat-SemiBold' }}>No Items Found</Text>
            </View>
          }
        />
      </ScrollView>
